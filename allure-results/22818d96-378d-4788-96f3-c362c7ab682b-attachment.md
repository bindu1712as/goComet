...
Error: locator.fill: Error: strict mode violation: locator('input[name="username"]').or(getByPlaceholder('Username')).or(locator('input').first()) resolved to 2 elements:
    1) <input name="_token" type="hidden" data-v-0af708be="" value="1.QNDFOkdgGz2B-X6hVoBtsqjI-cjp9ZSCKJ1JCLg2XMY.JKCLeXEqY2_nlTL-Ds5e1_eAmLu4k6P1ee0bPNV8C5UOvrNyPll0a-vMGQ"/> aka locator('input[name="_token"]')
