...
Analyzed files:
- [framework/ai/failureCollector.ts](framework/ai/failureCollector.ts#L22)
- [framework/ai/failureClassifier.ts](framework/ai/failureClassifier.ts#L18)
- [framework/ai/vectorStore.ts](framework/ai/vectorStore.ts#L22)
- [framework/ai/ragAnalyzer.ts](framework/ai/ragAnalyzer.ts#L10)
- [framework/ai/failureAnalyzer.ts](framework/ai/failureAnalyzer.ts#L18)
- [framework/ai/reportGenerator.ts](framework/ai/reportGenerator.ts#L22)
...
Key model:
- FailureArtifact interface in [framework/ai/failureCollector.ts](framework/ai/failureCollector.ts#L5)

Entry method:
- collectArtifacts in [framework/ai/failureCollector.ts](framework/ai/failureCollector.ts#L39)
...
Entry method:
- classify in [framework/ai/failureClassifier.ts](framework/ai/failureClassifier.ts#L23)
...
Pattern detectors:
- isLocatorFailure [framework/ai/failureClassifier.ts](framework/ai/failureClassifier.ts#L85)
- isTimingIssue [framework/ai/failureClassifier.ts](framework/ai/failureClassifier.ts#L102)
- isNetworkFailure [framework/ai/failureClassifier.ts](framework/ai/failureClassifier.ts#L116)
- isAuthFailure [framework/ai/failureClassifier.ts](framework/ai/failureClassifier.ts#L144)
...
- Automatic invocation hook is not present in [framework/fixtures/testfixtures.ts](framework/fixtures/testfixtures.ts#L16) yet.
