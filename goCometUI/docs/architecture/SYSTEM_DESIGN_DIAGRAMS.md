...
flowchart TB
    ...
    subgraph L4[Utilities]
      U1[env.ts]
      U2[logger.ts]
      U3[framework/utils/selfHealingLocator.ts]
    end
...
sequenceDiagram
    ...
    PW->>CFG: load [playwright.config.ts](#L3)
    PW->>PW: discover tests under tests/
    PW->>FX: initialize [framework/fixtures/testfixtures.ts](#L16)
...
- Search page object: [framework/pages/searchPage.ts](#L4)
- Active self-healing: [framework/utils/selfHealingLocator.ts](#L65)
- Legacy self-healing cache implementation: [framework/utils/selfHealingLocator.ts](#L65)
- Fixture composition: [framework/fixtures/testfixtures.ts](#L16)
- Failure analyzer entry: [framework/ai/failureAnalyzer.ts](#L25)
- Report generation entry: [framework/ai/reportGenerator.ts](#L39)
