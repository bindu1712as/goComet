...
- Username: [framework/pages/LoginPage.ts](framework/pages/LoginPage.ts#L15)
- Password: [framework/pages/LoginPage.ts](framework/pages/LoginPage.ts#L25)
- Submit button: [framework/pages/LoginPage.ts](framework/pages/LoginPage.ts#L31)
- Invalid login message: [framework/pages/LoginPage.ts](framework/pages/LoginPage.ts#L37)
...
File: [framework/pages/DashboardPage.ts](framework/pages/DashboardPage.ts#L7)
...
Fallback order:
1. getByRole [framework/pages/searchPage.ts](framework/pages/searchPage.ts#L26)
2. getByLabel [framework/pages/searchPage.ts](framework/pages/searchPage.ts#L31)
3. getByPlaceholder [framework/pages/searchPage.ts](framework/pages/searchPage.ts#L35)
4. getByText [framework/pages/searchPage.ts](framework/pages/searchPage.ts#L39)
5. locator css [framework/pages/searchPage.ts](framework/pages/searchPage.ts#L43)
6. locator xpath [framework/pages/searchPage.ts](framework/pages/searchPage.ts#L47)

Primary locator:
- input placeholder Search [framework/pages/searchPage.ts](framework/pages/searchPage.ts#L22)

Recovery engine:
- healLocator in [src/utils/selfHealingLocator.ts](src/utils/selfHealingLocator.ts#L65)
...
Active checks in [src/utils/selfHealingLocator.ts](src/utils/selfHealingLocator.ts#L154):
- locator.count > 0
- locator.isVisible
- locator.isEnabled
...
- Timestamped logs emitted by process stdout writer in [src/utils/selfHealingLocator.ts](src/utils/selfHealingLocator.ts#L172).

Playwright HTML report attachments:
- Recovery detail attach in [src/utils/selfHealingLocator.ts](src/utils/selfHealingLocator.ts#L182).
- Failure summary attach in [src/utils/selfHealingLocator.ts](src/utils/selfHealingLocator.ts#L140).
...
- Two self-healing modules exist; potential maintenance confusion.
