...
Primary references:
- [Jenkinsfile](Jenkinsfile#L1)
- [.github/workflows/test.yml](.github/workflows/test.yml#L1)
- [playwright.config.ts](playwright.config.ts#L17)

## 2. Jenkins Architecture

## 2.1 Pipeline structure

Reference file: [Jenkinsfile](Jenkinsfile#L1)

Stages:
1. Setup
2. Type Check
3. Install Browsers
4. Run Tests [Jenkinsfile](Jenkinsfile#L68)
5. Analyze Failures (conditional) [Jenkinsfile](Jenkinsfile#L89)
6. Post actions: publish and archive artifacts [Jenkinsfile](Jenkinsfile#L129)
...
References:
- [Jenkinsfile](Jenkinsfile#L129)
- [Jenkinsfile](Jenkinsfile#L145)
...
Reference:
- [Jenkinsfile](Jenkinsfile#L17)

## 3. GitHub Actions Architecture

## 3.1 Workflow structure

Reference: [.github/workflows/test.yml](.github/workflows/test.yml#L1)

Jobs:
- test matrix by browser [test.yml](.github/workflows/test.yml#L38)
- summary [test.yml](.github/workflows/test.yml#L135)
- failure-notification [test.yml](.github/workflows/test.yml#L159)
- pages-deploy [test.yml](.github/workflows/test.yml#L209)
- cleanup [test.yml](.github/workflows/test.yml#L284)
...
Reference:
- [.github/workflows/test.yml](.github/workflows/test.yml#L46)
...
Reference:
- [.github/workflows/test.yml](.github/workflows/test.yml#L87)
- [.github/workflows/test.yml](.github/workflows/test.yml#L96)
